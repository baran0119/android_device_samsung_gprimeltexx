...
/**
 * RIL customization for Samsung MSM8916 devices
 *
 * {@hide}
 */
public class SamsungQcomRIL extends RIL implements CommandsInterface {
    ...
    public SamsungQcomRIL(Context context, int preferredNetworkType, int cdmaSubscription) {
